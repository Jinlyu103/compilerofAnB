/******************************
  Program "resultOfAll5.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "resultOfAll5"
...
/********************
  Invariant records
 ********************/
int mu__invariant_142() // Invariant "sec1"
{
bool mu__quant143; 
mu__quant143 = TRUE;
{
...
bool mu__boolexpr145;
  if (!((mu_msgs[mu_i].mu_msgType) == (mu_nonce))) mu__boolexpr145 = FALSE ;
  else {
  mu__boolexpr145 = ((mu_msgs[mu_i].mu_noncePart) == (mu_Nb)) ; 
}
  if (!(mu__boolexpr145)) mu__boolexpr144 = TRUE ;
  else {
  mu__boolexpr144 = ((mu_Spy_known[mu_i]) == (mu_false)) ; 
}
if ( !(mu__boolexpr144) )
...
bool mu__condition_146() // Condition for Rule "sec1"
{
