...
procedure cons1(HostID:AgentType; Na1:NonceType; HostID:AgentType; Na1:NonceType; ; Var msg:Message; Var num:indexType);
  begin
    clear msg;
    clear num;    lookAddPat6(HostID, Na1, HostID, Na1, ,msg,num);
  end;
procedure cons2(HostID:AgentType; Na1:NonceType; HostID:AgentType; Na1:NonceType; ; Var msg:Message; Var num:indexType);
  begin
    clear msg;
    clear num;    lookAddPat6(HostID, Na1, HostID, Na1, ,msg,num);
  end;
...
procedure cons4(Server:AgentType; Na2:NonceType; HostID:AgentType; Na2:NonceType; ; Var msg:Message; Var num:indexType);
  begin
    clear msg;
    clear num;    lookAddPat6(Server, Na2, HostID, Na2, ,msg,num);
  end;
procedure cons5(HostID:AgentType; Na2:NonceType; HostID:AgentType; Na2:NonceType; ; Var msg:Message; Var num:indexType);
  begin
    clear msg;
    clear num;    lookAddPat6(HostID, Na2, HostID, Na2, ,msg,num);
  end;
procedure cons6(HostID:AgentType; Na2:NonceType; HostID:AgentType; Na2:NonceType; ; Var msg:Message; Var num:indexType);
  begin
    clear msg;
    clear num;    lookAddPat6(HostID, Na2, HostID, Na2, ,msg,num);
  end;
...
begin
   clear msg;
   cons1(roleHost[i].HostID,roleHost[i].Na1,roleHost[i].HostID,roleHost[i].Na1,null,msg,msgNo);
   ch[1].empty := false;
   ch[1].msg := msg;
...
begin
   clear msg;
   msg := ch[2].msg;
   destruct2(msg,roleHost[i].loc_Server,roleHost[i].loc_Na2,roleHost[i].loc_HostID,roleHost[i].loc_Na2,null);
   eve_end:= eve_end + 1 ;
   ...
   if(roleHost[i].loc_HostID=roleHost[i].HostID&null)then
     ch[2].empty:=true;
     roleHost[i].st := Host3;
   endif;
end;
...
begin
   clear msg;
   cons3(roleHost[i].HostID,roleHost[i].loc_Na2,roleHost[i].HostID,roleHost[i].loc_Na2,null,msg,msgNo);
   ch[3].empty := false;
   ch[3].msg := msg;
...
begin
   clear msg;
   msg := ch[1].msg;
   destruct1(msg,roleGateway[i].loc_HostID,roleGateway[i].loc_Na1,roleGateway[i].loc_HostID,roleGateway[i].loc_Na1,null);
   eve_end:= eve_end + 1 ;
   systemEvent[eve_end].eveType := receive;
   systemEvent[eve_end].sender := roleGateway[i].loc_A;
   systemEvent[eve_end].receiver := ch[1].receiver;
   systemEvent[eve_end].msg := ch[1].msg;
   if(roleGateway[i].loc_HostID=roleGateway[i].HostID&roleGateway[i].loc_HostID=roleGateway[i].HostID&null)then
     ch[1].empty:=true;
...
begin
   clear msg;
   cons2(roleGateway[i].HostID,roleGateway[i].loc_Na1,roleGateway[i].HostID,roleGateway[i].loc_Na1,null,msg,msgNo);
   ch[2].empty := false;
   ch[2].msg := msg;
...
begin
   clear msg;
   cons4(roleGateway[i].Server,roleGateway[i].loc_Na2,roleGateway[i].HostID,roleGateway[i].loc_Na2,null,msg,msgNo);
   ch[4].empty := false;
   ch[4].msg := msg;
...
begin
   clear msg;
   msg := ch[5].msg;
   destruct5(msg,roleGateway[i].loc_HostID,roleGateway[i].loc_Na2,roleGateway[i].loc_HostID,roleGateway[i].loc_Na2,null);
   eve_end:= eve_end + 1 ;
   systemEvent[eve_end].eveType := receive;
   systemEvent[eve_end].sender := roleGateway[i].loc_A;
...
begin
   clear msg;
   cons6(roleGateway[i].HostID,roleGateway[i].loc_Na2,roleGateway[i].HostID,roleGateway[i].loc_Na2,null,msg,msgNo);
   ch[6].empty := false;
   ch[6].msg := msg;
...
begin
   clear msg;
   msg := ch[1].msg;
   destruct1(msg,roleServer[i].loc_HostID,roleServer[i].loc_Na1,roleServer[i].loc_HostID,roleServer[i].loc_Na1,null);
   eve_end:= eve_end + 1 ;
   systemEvent[eve_end].eveType := receive;
   systemEvent[eve_end].sender := roleServer[i].loc_A;
   systemEvent[eve_end].receiver := ch[1].receiver;
   systemEvent[eve_end].msg := ch[1].msg;
   if(roleServer[i].loc_HostID=roleServer[i].HostID&roleServer[i].loc_HostID=roleServer[i].HostID&null)then
     ch[1].empty:=true;
...
begin
   clear msg;
   msg := ch[3].msg;
   destruct3(msg,roleServer[i].loc_HostID,roleServer[i].loc_Na2,roleServer[i].loc_HostID,roleServer[i].loc_Na2,null);
   eve_end:= eve_end + 1 ;
   systemEvent[eve_end].eveType := receive;
   systemEvent[eve_end].sender := roleServer[i].loc_A;
   systemEvent[eve_end].receiver := ch[3].receiver;
   systemEvent[eve_end].msg := ch[3].msg;
   if(roleServer[i].loc_HostID=roleServer[i].HostID&roleServer[i].loc_Na2=roleServer[i].Na2&roleServer[i].loc_HostID=roleServer[i].HostID&roleServer[i].loc_Na2=roleServer[i].Na2&null)then
     ch[3].empty:=true;
