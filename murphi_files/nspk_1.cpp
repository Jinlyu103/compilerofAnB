/******************************
  Program "nspk_1.m" compiled by "Caching Murphi Release 5.4.9.1"
...
{
bool mu__boolexpr16;
  if (!((mu_msgs[mu_i].mu_k.mu_encTyp) == (mu_PK))) mu__boolexpr16 = FALSE ;
  else {
  mu__boolexpr16 = ((mu_msgs[mu_i].mu_k.mu_ag) == (mu_B)) ; 
}
if ( mu__boolexpr16 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr18;
  if (!((mu_msgs[mu_i].mu_concatPart1) == (mu_i1))) mu__boolexpr18 = FALSE ;
  else {
  mu__boolexpr18 = ((mu_msgs[mu_i].mu_concatPart2) == (mu_i2)) ; 
}
if ( mu__boolexpr18 )
{
mu_index = mu_i;
...
bool mu__boolexpr21;
bool mu__boolexpr22;
  if (!((mu_indexTyperuder.mu_st) == (mu_getmsg3))) mu__boolexpr22 = FALSE ;
  else {
  mu__boolexpr22 = ((mu_ch[3].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr22)) mu__boolexpr21 = FALSE ;
  else {
  mu__boolexpr21 = ((mu_allMsgs[mu_i]) > (0)) ; 
}
...
bool mu__boolexpr23;
bool mu__boolexpr24;
  if (!((mu_indexTyperuder.mu_st) == (mu_getmsg3))) mu__boolexpr24 = FALSE ;
  else {
  mu__boolexpr24 = ((mu_ch[3].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr24)) mu__boolexpr23 = FALSE ;
  else {
  mu__boolexpr23 = ((mu_allMsgs[mu_i]) > (0)) ; 
}
	      if (mu__boolexpr23) {
		if ( ( TRUE  ) )
		  return;
  ...
  void Code(unsigned r)
  {
    ...
    r = r / 200;
bool mu__boolexpr25;
  if (!(mu_Spy_known[mu_allMsgs[mu_i]])) mu__boolexpr25 = FALSE ;
  else {
  mu__boolexpr25 = ((mu_emit[mu_allMsgs[mu_i]]) == (mu_false)) ; 
}
if ( mu__boolexpr25 )
{
mu_ch[3].clear();
...
bool mu__boolexpr26;
bool mu__boolexpr27;
  if (!((mu_indexTyperuder.mu_st) == (mu_getmsg1))) mu__boolexpr27 = FALSE ;
  else {
  mu__boolexpr27 = ((mu_ch[1].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr27)) mu__boolexpr26 = FALSE ;
  else {
  mu__boolexpr26 = ((mu_allMsgs[mu_i]) > (0)) ; 
}
...
bool mu__boolexpr28;
bool mu__boolexpr29;
  if (!((mu_indexTyperuder.mu_st) == (mu_getmsg1))) mu__boolexpr29 = FALSE ;
  else {
  mu__boolexpr29 = ((mu_ch[1].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr29)) mu__boolexpr28 = FALSE ;
  else {
  mu__boolexpr28 = ((mu_allMsgs[mu_i]) > (0)) ; 
}
	      if (mu__boolexpr28) {
		if ( ( TRUE  ) )
		  return;
  ...
  void Code(unsigned r)
  {
    ...
    r = r / 200;
bool mu__boolexpr30;
  if (!(mu_Spy_known[mu_allMsgs[mu_i]])) mu__boolexpr30 = FALSE ;
  else {
  mu__boolexpr30 = ((mu_emit[mu_allMsgs[mu_i]]) == (mu_false)) ; 
}
if ( mu__boolexpr30 )
{
...
bool mu__boolexpr31;
bool mu__boolexpr32;
  if (!((mu_indexTyperuder.mu_st) == (mu_getmsg1))) mu__boolexpr32 = FALSE ;
  else {
  mu__boolexpr32 = ((mu_ch[1].mu_empty) == (mu_true)) ; 
}
...
bool mu__boolexpr33;
bool mu__boolexpr34;
  if (!((mu_indexTyperuder.mu_st) == (mu_getmsg1))) mu__boolexpr34 = FALSE ;
  else {
  mu__boolexpr34 = ((mu_ch[1].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr34)) mu__boolexpr33 = FALSE ;
  else {
  mu__boolexpr33 = ((mu_allMsgs[mu_i]) > (0)) ; 
}
	      if (mu__boolexpr33) {
		if ( ( TRUE  ) )
		  return;
  ...
  void Code(unsigned r)
  {
    ...
    r = r / 200;
bool mu__boolexpr35;
  if (!(mu_Spy_known[mu_allMsgs[mu_i]])) mu__boolexpr35 = FALSE ;
  else {
  mu__boolexpr35 = ((mu_emit[mu_allMsgs[mu_i]]) == (mu_false)) ; 
}
if ( mu__boolexpr35 )
{
mu_ch[1].mu_msg.clear();
...
bool mu__boolexpr36;
bool mu__boolexpr37;
  if (!((mu_indexTyperuder.mu_st) == (mu_emitting2))) mu__boolexpr37 = FALSE ;
  else {
  mu__boolexpr37 = ((mu_ch[3].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr37)) mu__boolexpr36 = FALSE ;
  else {
  mu__boolexpr36 = ((mu_ch[3].mu_receiver) == (mu_indexTyperuder_)) ; 
}
...
bool mu__boolexpr38;
bool mu__boolexpr39;
  if (!((mu_indexTyperuder.mu_st) == (mu_emitting2))) mu__boolexpr39 = FALSE ;
  else {
  mu__boolexpr39 = ((mu_ch[3].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr39)) mu__boolexpr38 = FALSE ;
  else {
  mu__boolexpr38 = ((mu_ch[3].mu_receiver) == (mu_indexTyperuder_)) ; 
}
	      if (mu__boolexpr38) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr40;
bool mu__boolexpr41;
  if (!((mu_indexTyperuder.mu_st) == (mu_emitting1))) mu__boolexpr41 = FALSE ;
  else {
  mu__boolexpr41 = ((mu_ch[2].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr41)) mu__boolexpr40 = FALSE ;
  else {
  mu__boolexpr40 = ((mu_ch[2].mu_receiver) == (mu_indexTyperuder_)) ; 
}
...
bool mu__boolexpr42;
bool mu__boolexpr43;
  if (!((mu_indexTyperuder.mu_st) == (mu_emitting1))) mu__boolexpr43 = FALSE ;
  else {
  mu__boolexpr43 = ((mu_ch[2].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr43)) mu__boolexpr42 = FALSE ;
  else {
  mu__boolexpr42 = ((mu_ch[2].mu_receiver) == (mu_indexTyperuder_)) ; 
}
	      if (mu__boolexpr42) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr44;
bool mu__boolexpr45;
  if (!((mu_indexTyperuder.mu_st) == (mu_waiting))) mu__boolexpr45 = FALSE ;
  else {
  mu__boolexpr45 = ((mu_ch[1].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr45)) mu__boolexpr44 = FALSE ;
  else {
  mu__boolexpr44 = ((mu_ch[1].mu_receiver) == (mu_indexTyperuder_)) ; 
}
...
bool mu__boolexpr46;
bool mu__boolexpr47;
  if (!((mu_indexTyperuder.mu_st) == (mu_waiting))) mu__boolexpr47 = FALSE ;
  else {
  mu__boolexpr47 = ((mu_ch[1].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr47)) mu__boolexpr46 = FALSE ;
  else {
  mu__boolexpr46 = ((mu_ch[1].mu_receiver) == (mu_indexTyperuder_)) ; 
}
	      if (mu__boolexpr46) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr49;
bool mu__boolexpr50;
  if (!((mu_bobs[mu_i].mu_st) == (mu_B2))) mu__boolexpr50 = FALSE ;
  else {
  mu__boolexpr50 = ((mu_ch[3].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr50)) mu__boolexpr49 = FALSE ;
  else {
  mu__boolexpr49 = ((mu_indexTyperuder.mu_st) == (mu_emitting3)) ; 
}
  if (!(mu__boolexpr49)) mu__boolexpr48 = FALSE ;
  else {
  mu__boolexpr48 = ((mu_ch[3].mu_receiver) == (mu_bobs[mu_i].mu_B)) ; 
}
...
bool mu__boolexpr52;
bool mu__boolexpr53;
  if (!((mu_bobs[mu_i].mu_st) == (mu_B2))) mu__boolexpr53 = FALSE ;
  else {
  mu__boolexpr53 = ((mu_ch[3].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr53)) mu__boolexpr52 = FALSE ;
  else {
  mu__boolexpr52 = ((mu_indexTyperuder.mu_st) == (mu_emitting3)) ; 
}
  if (!(mu__boolexpr52)) mu__boolexpr51 = FALSE ;
  else {
  mu__boolexpr51 = ((mu_ch[3].mu_receiver) == (mu_bobs[mu_i].mu_B)) ; 
}
	      if (mu__boolexpr51) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr54;
  if (!((mu_loc_B) == (mu_bobs[mu_i].mu_B))) mu__boolexpr54 = FALSE ;
  else {
  mu__boolexpr54 = ((mu_loc_Nb) == (mu_bobs[mu_i].mu_Nb)) ; 
}
if ( mu__boolexpr54 )
{
...
bool mu__boolexpr56;
bool mu__boolexpr57;
  if (!((mu_bobs[mu_i].mu_st) == (mu_B1))) mu__boolexpr57 = FALSE ;
  else {
  mu__boolexpr57 = ((mu_ch[1].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr57)) mu__boolexpr56 = FALSE ;
  else {
  mu__boolexpr56 = ((mu_indexTyperuder.mu_st) == (mu_emitting1)) ; 
}
  if (!(mu__boolexpr56)) mu__boolexpr55 = FALSE ;
  else {
  mu__boolexpr55 = ((mu_ch[1].mu_receiver) == (mu_bobs[mu_i].mu_B)) ; 
}
...
bool mu__boolexpr59;
bool mu__boolexpr60;
  if (!((mu_bobs[mu_i].mu_st) == (mu_B1))) mu__boolexpr60 = FALSE ;
  else {
  mu__boolexpr60 = ((mu_ch[1].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr60)) mu__boolexpr59 = FALSE ;
  else {
  mu__boolexpr59 = ((mu_indexTyperuder.mu_st) == (mu_emitting1)) ; 
}
  if (!(mu__boolexpr59)) mu__boolexpr58 = FALSE ;
  else {
  mu__boolexpr58 = ((mu_ch[1].mu_receiver) == (mu_bobs[mu_i].mu_B)) ; 
}
	      if (mu__boolexpr58) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr62;
bool mu__boolexpr63;
  if (!((mu_alices[mu_i].mu_st) == (mu_A2))) mu__boolexpr63 = FALSE ;
  else {
  mu__boolexpr63 = ((mu_ch[2].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr63)) mu__boolexpr62 = FALSE ;
  else {
  mu__boolexpr62 = ((mu_indexTyperuder.mu_st) == (mu_emitting2)) ; 
}
  if (!(mu__boolexpr62)) mu__boolexpr61 = FALSE ;
  else {
  mu__boolexpr61 = ((mu_ch[2].mu_receiver) == (mu_alices[mu_i].mu_A)) ; 
}
...
bool mu__boolexpr65;
bool mu__boolexpr66;
  if (!((mu_alices[mu_i].mu_st) == (mu_A2))) mu__boolexpr66 = FALSE ;
  else {
  mu__boolexpr66 = ((mu_ch[2].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr66)) mu__boolexpr65 = FALSE ;
  else {
  mu__boolexpr65 = ((mu_indexTyperuder.mu_st) == (mu_emitting2)) ; 
}
  if (!(mu__boolexpr65)) mu__boolexpr64 = FALSE ;
  else {
  mu__boolexpr64 = ((mu_ch[2].mu_receiver) == (mu_alices[mu_i].mu_A)) ; 
}
	      if (mu__boolexpr64) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr67;
  if (!((mu_loc_A) == (mu_alices[mu_i].mu_A))) mu__boolexpr67 = FALSE ;
  else {
  mu__boolexpr67 = ((mu_loc_Na) == (mu_alices[mu_i].mu_Na)) ; 
}
if ( mu__boolexpr67 )
{
mu_ch[2].mu_empty = mu_true;
...
public:
  ...
  bool Condition(unsigned r)
  {
    ...
    r = r / 1;
bool mu__boolexpr68;
  if (!((mu_alices[mu_i].mu_st) == (mu_A1))) mu__boolexpr68 = FALSE ;
  else {
  mu__boolexpr68 = ((mu_ch[1].mu_empty) == (mu_true)) ; 
}
  ...
  void NextRule(unsigned & what_rule)
  {
	...
	if ( ( TRUE  ) ) {
bool mu__boolexpr69;
  if (!((mu_alices[mu_i].mu_st) == (mu_A1))) mu__boolexpr69 = FALSE ;
  else {
  mu__boolexpr69 = ((mu_ch[1].mu_empty) == (mu_true)) ; 
}
	      if (mu__boolexpr69) {
		if ( ( TRUE  ) )
		  return;
...
void SetNextEnabledRule(unsigned & what_rule)
{
  ...
  if (what_rule>=607 && what_rule<608)
    { R10.NextRule(what_rule);
      if (what_rule<608) return; }
  if (what_rule>=608 && what_rule<609)
    { R11.NextRule(what_rule);
      if (what_rule<609) return; }
}
bool Condition(unsigned r)
{
  category = CONDITION;
  ...
  if (r>=607 && r<=607) return R10.Condition(r-607);
  if (r>=608 && r<=608) return R11.Condition(r-608);
...
void Code(unsigned r)
{
  ...
  if (r>=607 && r<=607) { R10.Code(r-607); return; } 
  if (r>=608 && r<=608) { R11.Code(r-608); return; } 
}
int Priority(unsigned short r)
{
  ...
  if (r>=607 && r<=607) { return R10.Priority(); } 
  if (r>=608 && r<=608) { return R11.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  ...
  if (r>=607 && r<=607) return R10.Name(r-607);
  if (r>=608 && r<=608) return R11.Name(r-608);
  return NULL;
}
};
const unsigned numrules = 609;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 609
