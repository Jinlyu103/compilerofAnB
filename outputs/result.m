  ...
  begin
    ...
    while (i1 <= pat1Set.length) do
      ...
      while (i2 <= pat1Set.length) do
        if (matchPat(msgs[construct6By11(pat1Set.content[i1], pat1Set.content[i2])], sPat6Set) &
            !Spy_known[construct6By11(pat1Set.content[i1], pat1Set.content[i2])]) then
             concatMsgNo := construct6By11(pat1Set.content[i1], pat1Set.content[i2]);
...
invariant "sec1"  forall i:indexType do
