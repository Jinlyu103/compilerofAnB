...
type
  ...
  NonceType : enum{n3, n1, n2, t, l, intruderNonce, anyNonce};  
    ...
    if (flag_pat3) then
      if(!exist(pat3Set,msgNo)) then
        ...
        while (i <= pat9Set.length) do
          aDecryptionPat9(msgs[pat9Set.content[i]]);
          i := i+1;
        endwhile;
        aEncryptionPat9();
        i := 1;
        ...
        while (i <= pat11Set.length) do
          aDecryptionPat11(msgs[pat11Set.content[i]]);
          i := i+1;
        endwhile;
        aEncryptionPat11();
        i := 1;
        ...
        while (i <= pat14Set.length) do
          aDecryptionPat14(msgs[pat14Set.content[i]]);
          i := i+1;
        endwhile;
        aEncryptionPat14();
        i := 1;
        while (i <= pat15Set.length) do
          deconcatPat15(msgs[pat15Set.content[i]]);
          i := i+1;
        endwhile;
        enconcatPat15();
      endif;
