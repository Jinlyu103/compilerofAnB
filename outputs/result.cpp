...
class mu_1_NonceType: public mu__byte
{
 public:
  ...
  mu_1_NonceType (const char *name, int os): mu__byte(6, 12, 3, name, os) {};
  mu_1_NonceType (void): mu__byte(6, 12, 3) {};
  mu_1_NonceType (int val): mu__byte(6, 12, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
const char *mu_1_NonceType::values[] = {"n3","n1","n2","t","l","intruderNonce","anyNonce",NULL };
...
class mu_1_EncryptType: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_EncryptType::values[ int(val) - 13] );
    else return ( s << "Undefined" );
  };

  mu_1_EncryptType (const char *name, int os): mu__byte(13, 15, 2, name, os) {};
  mu_1_EncryptType (void): mu__byte(13, 15, 2) {};
  mu_1_EncryptType (int val): mu__byte(13, 15, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_SStatus: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_SStatus::values[ int(val) - 16] );
    else return ( s << "Undefined" );
  };

  mu_1_SStatus (const char *name, int os): mu__byte(16, 19, 3, name, os) {};
  mu_1_SStatus (void): mu__byte(16, 19, 3) {};
  mu_1_SStatus (int val): mu__byte(16, 19, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_CStatus: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_CStatus::values[ int(val) - 20] );
    else return ( s << "Undefined" );
  };

  mu_1_CStatus (const char *name, int os): mu__byte(20, 23, 3, name, os) {};
  mu_1_CStatus (void): mu__byte(20, 23, 3) {};
  mu_1_CStatus (int val): mu__byte(20, 23, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_ASStatus: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_ASStatus::values[ int(val) - 24] );
    else return ( s << "Undefined" );
  };

  mu_1_ASStatus (const char *name, int os): mu__byte(24, 27, 3, name, os) {};
  mu_1_ASStatus (void): mu__byte(24, 27, 3) {};
  mu_1_ASStatus (int val): mu__byte(24, 27, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_MsgType: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_MsgType::values[ int(val) - 28] );
    else return ( s << "Undefined" );
  };

  mu_1_MsgType (const char *name, int os): mu__byte(28, 35, 4, name, os) {};
  mu_1_MsgType (void): mu__byte(28, 35, 4) {};
  mu_1_MsgType (int val): mu__byte(28, 35, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
const int mu_t = 9;
const int mu_l = 10;
const int mu_intruderNonce = 11;
const int mu_anyNonce = 12;
const int mu_PK = 13;
const int mu_SK = 14;
const int mu_Symk = 15;
const int mu_S1 = 16;
const int mu_S2 = 17;
const int mu_S3 = 18;
const int mu_S4 = 19;
...
const int mu_AS3 = 26;
const int mu_AS4 = 27;
const int mu_null = 28;
const int mu_agent = 29;
const int mu_nonce = 30;
const int mu_key = 31;
const int mu_aenc = 32;
const int mu_senc = 33;
const int mu_concat = 34;
const int mu_hash = 35;
...
mu_i = 1;
{
  bool mu__while_expr_315;  mu__while_expr_315 = (mu_i) <= (mu_pat3Set.mu_length);
...
mu__while_expr_315 = (mu_i) <= (mu_pat3Set.mu_length);
}
};
mu_enconcatPat3 (  );
mu_i = 1;
...
if ( ++mu__counter_322 > args->loopmax.value )
  Error.Error("Too many iterations in while loop.");
{
mu_aDecryptionPat9 ( mu_msgs[mu_pat9Set.mu_content[mu_i]] );
mu_i = (mu_i) + (1);
};
...
mu_i = 1;
{
  bool mu__while_expr_325;  mu__while_expr_325 = (mu_i) <= (mu_pat10Set.mu_length);
...
mu__while_expr_325 = (mu_i) <= (mu_pat10Set.mu_length);
}
};
mu_enconcatPat10 (  );
mu_i = 1;
{
  bool mu__while_expr_327;  mu__while_expr_327 = (mu_i) <= (mu_pat11Set.mu_length);
int mu__counter_326 = 0;
while (mu__while_expr_327) {
if ( ++mu__counter_326 > args->loopmax.value )
  Error.Error("Too many iterations in while loop.");
{
mu_aDecryptionPat11 ( mu_msgs[mu_pat11Set.mu_content[mu_i]] );
mu_i = (mu_i) + (1);
};
mu__while_expr_327 = (mu_i) <= (mu_pat11Set.mu_length);
}
};
mu_aEncryptionPat11 (  );
mu_i = 1;
{
  bool mu__while_expr_329;  mu__while_expr_329 = (mu_i) <= (mu_pat12Set.mu_length);
...
mu__while_expr_329 = (mu_i) <= (mu_pat12Set.mu_length);
}
};
mu_enconcatPat12 (  );
mu_i = 1;
{
  bool mu__while_expr_331;  mu__while_expr_331 = (mu_i) <= (mu_pat13Set.mu_length);
...
mu__while_expr_331 = (mu_i) <= (mu_pat13Set.mu_length);
}
};
mu_enconcatPat13 (  );
mu_i = 1;
{
  bool mu__while_expr_333;  mu__while_expr_333 = (mu_i) <= (mu_pat14Set.mu_length);
int mu__counter_332 = 0;
while (mu__while_expr_333) {
if ( ++mu__counter_332 > args->loopmax.value )
  Error.Error("Too many iterations in while loop.");
{
mu_aDecryptionPat14 ( mu_msgs[mu_pat14Set.mu_content[mu_i]] );
mu_i = (mu_i) + (1);
};
mu__while_expr_333 = (mu_i) <= (mu_pat14Set.mu_length);
}
};
mu_aEncryptionPat14 (  );
mu_i = 1;
{
  bool mu__while_expr_335;  mu__while_expr_335 = (mu_i) <= (mu_pat15Set.mu_length);
int mu__counter_334 = 0;
while (mu__while_expr_335) {
if ( ++mu__counter_334 > args->loopmax.value )
  Error.Error("Too many iterations in while loop.");
{
mu_deconcatPat15 ( mu_msgs[mu_pat15Set.mu_content[mu_i]] );
mu_i = (mu_i) + (1);
};
mu__while_expr_335 = (mu_i) <= (mu_pat15Set.mu_length);
}
};
mu_enconcatPat15 (  );
}
...
mu_i = 1;
{
  bool mu__while_expr_337;  mu__while_expr_337 = (mu_i) <= (mu_pat3Set.mu_length);
...
mu__while_expr_337 = (mu_i) <= (mu_pat3Set.mu_length);
}
};
mu_enconcatPat3 (  );
mu_i = 1;
{
  bool mu__while_expr_339;  mu__while_expr_339 = (mu_i) <= (mu_pat5Set.mu_length);
...
mu__while_expr_339 = (mu_i) <= (mu_pat5Set.mu_length);
}
};
mu_enconcatPat5 (  );
mu_i = 1;
{
  bool mu__while_expr_341;  mu__while_expr_341 = (mu_i) <= (mu_pat7Set.mu_length);
...
mu__while_expr_341 = (mu_i) <= (mu_pat7Set.mu_length);
}
};
mu_aEncryptionPat7 (  );
mu_i = 1;
{
  bool mu__while_expr_343;  mu__while_expr_343 = (mu_i) <= (mu_pat8Set.mu_length);
...
mu__while_expr_343 = (mu_i) <= (mu_pat8Set.mu_length);
}
};
mu_enconcatPat8 (  );
mu_i = 1;
{
  bool mu__while_expr_345;  mu__while_expr_345 = (mu_i) <= (mu_pat9Set.mu_length);
...
mu__while_expr_345 = (mu_i) <= (mu_pat9Set.mu_length);
}
};
mu_aEncryptionPat9 (  );
mu_i = 1;
{
  bool mu__while_expr_347;  mu__while_expr_347 = (mu_i) <= (mu_pat10Set.mu_length);
...
mu__while_expr_347 = (mu_i) <= (mu_pat10Set.mu_length);
}
};
mu_enconcatPat10 (  );
mu_i = 1;
{
  bool mu__while_expr_349;  mu__while_expr_349 = (mu_i) <= (mu_pat11Set.mu_length);
...
mu__while_expr_349 = (mu_i) <= (mu_pat11Set.mu_length);
}
};
mu_aEncryptionPat11 (  );
mu_i = 1;
{
  bool mu__while_expr_351;  mu__while_expr_351 = (mu_i) <= (mu_pat12Set.mu_length);
...
mu__while_expr_351 = (mu_i) <= (mu_pat12Set.mu_length);
}
};
mu_enconcatPat12 (  );
mu_i = 1;
{
  bool mu__while_expr_353;  mu__while_expr_353 = (mu_i) <= (mu_pat13Set.mu_length);
...
mu__while_expr_353 = (mu_i) <= (mu_pat13Set.mu_length);
}
};
mu_enconcatPat13 (  );
mu_i = 1;
{
  bool mu__while_expr_355;  mu__while_expr_355 = (mu_i) <= (mu_pat14Set.mu_length);
...
mu__while_expr_355 = (mu_i) <= (mu_pat14Set.mu_length);
}
};
mu_aEncryptionPat14 (  );
mu_i = 1;
{
  bool mu__while_expr_357;  mu__while_expr_357 = (mu_i) <= (mu_pat15Set.mu_length);
...
mu__while_expr_357 = (mu_i) <= (mu_pat15Set.mu_length);
}
};
mu_enconcatPat15 (  );
}
...
mu_i = 1;
{
  bool mu__while_expr_359;  mu__while_expr_359 = (mu_i) <= (mu_pat3Set.mu_length);
...
mu__while_expr_359 = (mu_i) <= (mu_pat3Set.mu_length);
}
};
mu_enconcatPat3 (  );
mu_i = 1;
{
  bool mu__while_expr_361;  mu__while_expr_361 = (mu_i) <= (mu_pat5Set.mu_length);
...
mu__while_expr_361 = (mu_i) <= (mu_pat5Set.mu_length);
}
};
mu_enconcatPat5 (  );
mu_i = 1;
{
  bool mu__while_expr_363;  mu__while_expr_363 = (mu_i) <= (mu_pat7Set.mu_length);
...
mu__while_expr_363 = (mu_i) <= (mu_pat7Set.mu_length);
}
};
mu_aEncryptionPat7 (  );
mu_i = 1;
{
  bool mu__while_expr_365;  mu__while_expr_365 = (mu_i) <= (mu_pat8Set.mu_length);
...
mu__while_expr_365 = (mu_i) <= (mu_pat8Set.mu_length);
}
};
mu_enconcatPat8 (  );
mu_i = 1;
{
  bool mu__while_expr_367;  mu__while_expr_367 = (mu_i) <= (mu_pat9Set.mu_length);
...
mu__while_expr_367 = (mu_i) <= (mu_pat9Set.mu_length);
}
};
mu_aEncryptionPat9 (  );
mu_i = 1;
{
  bool mu__while_expr_369;  mu__while_expr_369 = (mu_i) <= (mu_pat10Set.mu_length);
...
mu__while_expr_369 = (mu_i) <= (mu_pat10Set.mu_length);
}
};
mu_enconcatPat10 (  );
mu_i = 1;
{
  bool mu__while_expr_371;  mu__while_expr_371 = (mu_i) <= (mu_pat11Set.mu_length);
...
mu__while_expr_371 = (mu_i) <= (mu_pat11Set.mu_length);
}
};
mu_aEncryptionPat11 (  );
mu_i = 1;
{
  bool mu__while_expr_373;  mu__while_expr_373 = (mu_i) <= (mu_pat12Set.mu_length);
...
mu__while_expr_373 = (mu_i) <= (mu_pat12Set.mu_length);
}
};
mu_enconcatPat12 (  );
mu_i = 1;
{
  bool mu__while_expr_375;  mu__while_expr_375 = (mu_i) <= (mu_pat13Set.mu_length);
...
mu__while_expr_375 = (mu_i) <= (mu_pat13Set.mu_length);
}
};
mu_enconcatPat13 (  );
mu_i = 1;
{
  bool mu__while_expr_377;  mu__while_expr_377 = (mu_i) <= (mu_pat14Set.mu_length);
...
mu__while_expr_377 = (mu_i) <= (mu_pat14Set.mu_length);
}
};
mu_aEncryptionPat14 (  );
mu_i = 1;
{
  bool mu__while_expr_379;  mu__while_expr_379 = (mu_i) <= (mu_pat15Set.mu_length);
...
mu__while_expr_379 = (mu_i) <= (mu_pat15Set.mu_length);
}
};
mu_enconcatPat15 (  );
}
...
mu_i = 1;
{
  bool mu__while_expr_381;  mu__while_expr_381 = (mu_i) <= (mu_pat3Set.mu_length);
...
mu__while_expr_381 = (mu_i) <= (mu_pat3Set.mu_length);
}
};
mu_enconcatPat3 (  );
mu_i = 1;
{
  bool mu__while_expr_383;  mu__while_expr_383 = (mu_i) <= (mu_pat5Set.mu_length);
...
mu__while_expr_383 = (mu_i) <= (mu_pat5Set.mu_length);
}
};
mu_enconcatPat5 (  );
mu_i = 1;
{
  bool mu__while_expr_385;  mu__while_expr_385 = (mu_i) <= (mu_pat7Set.mu_length);
...
mu__while_expr_385 = (mu_i) <= (mu_pat7Set.mu_length);
}
};
mu_aEncryptionPat7 (  );
mu_i = 1;
{
  bool mu__while_expr_387;  mu__while_expr_387 = (mu_i) <= (mu_pat8Set.mu_length);
...
mu__while_expr_387 = (mu_i) <= (mu_pat8Set.mu_length);
}
};
mu_enconcatPat8 (  );
mu_i = 1;
{
  bool mu__while_expr_389;  mu__while_expr_389 = (mu_i) <= (mu_pat9Set.mu_length);
...
mu__while_expr_389 = (mu_i) <= (mu_pat9Set.mu_length);
}
};
mu_aEncryptionPat9 (  );
mu_i = 1;
{
  bool mu__while_expr_391;  mu__while_expr_391 = (mu_i) <= (mu_pat10Set.mu_length);
...
mu__while_expr_391 = (mu_i) <= (mu_pat10Set.mu_length);
}
};
mu_enconcatPat10 (  );
mu_i = 1;
{
  bool mu__while_expr_393;  mu__while_expr_393 = (mu_i) <= (mu_pat11Set.mu_length);
...
mu__while_expr_393 = (mu_i) <= (mu_pat11Set.mu_length);
}
};
mu_aEncryptionPat11 (  );
mu_i = 1;
{
  bool mu__while_expr_395;  mu__while_expr_395 = (mu_i) <= (mu_pat12Set.mu_length);
...
mu__while_expr_395 = (mu_i) <= (mu_pat12Set.mu_length);
}
};
mu_enconcatPat12 (  );
mu_i = 1;
{
  bool mu__while_expr_397;  mu__while_expr_397 = (mu_i) <= (mu_pat13Set.mu_length);
...
mu__while_expr_397 = (mu_i) <= (mu_pat13Set.mu_length);
}
};
mu_enconcatPat13 (  );
mu_i = 1;
{
  bool mu__while_expr_399;  mu__while_expr_399 = (mu_i) <= (mu_pat14Set.mu_length);
...
mu__while_expr_399 = (mu_i) <= (mu_pat14Set.mu_length);
}
};
mu_aEncryptionPat14 (  );
mu_i = 1;
{
  bool mu__while_expr_401;  mu__while_expr_401 = (mu_i) <= (mu_pat15Set.mu_length);
...
mu__while_expr_401 = (mu_i) <= (mu_pat15Set.mu_length);
}
};
mu_enconcatPat15 (  );
}
...
mu_i = 1;
{
  bool mu__while_expr_403;  mu__while_expr_403 = (mu_i) <= (mu_pat3Set.mu_length);
...
mu__while_expr_403 = (mu_i) <= (mu_pat3Set.mu_length);
}
};
mu_enconcatPat3 (  );
mu_i = 1;
{
  bool mu__while_expr_405;  mu__while_expr_405 = (mu_i) <= (mu_pat5Set.mu_length);
...
mu__while_expr_405 = (mu_i) <= (mu_pat5Set.mu_length);
}
};
mu_enconcatPat5 (  );
mu_i = 1;
{
  bool mu__while_expr_407;  mu__while_expr_407 = (mu_i) <= (mu_pat7Set.mu_length);
...
mu__while_expr_407 = (mu_i) <= (mu_pat7Set.mu_length);
}
};
mu_aEncryptionPat7 (  );
mu_i = 1;
{
  bool mu__while_expr_409;  mu__while_expr_409 = (mu_i) <= (mu_pat8Set.mu_length);
...
mu__while_expr_409 = (mu_i) <= (mu_pat8Set.mu_length);
}
};
mu_enconcatPat8 (  );
mu_i = 1;
{
  bool mu__while_expr_411;  mu__while_expr_411 = (mu_i) <= (mu_pat9Set.mu_length);
...
mu__while_expr_411 = (mu_i) <= (mu_pat9Set.mu_length);
}
};
mu_aEncryptionPat9 (  );
mu_i = 1;
{
  bool mu__while_expr_413;  mu__while_expr_413 = (mu_i) <= (mu_pat10Set.mu_length);
...
mu__while_expr_413 = (mu_i) <= (mu_pat10Set.mu_length);
}
};
mu_enconcatPat10 (  );
mu_i = 1;
{
  bool mu__while_expr_415;  mu__while_expr_415 = (mu_i) <= (mu_pat11Set.mu_length);
...
mu__while_expr_415 = (mu_i) <= (mu_pat11Set.mu_length);
}
};
mu_aEncryptionPat11 (  );
mu_i = 1;
{
  bool mu__while_expr_417;  mu__while_expr_417 = (mu_i) <= (mu_pat12Set.mu_length);
...
mu__while_expr_417 = (mu_i) <= (mu_pat12Set.mu_length);
}
};
mu_enconcatPat12 (  );
mu_i = 1;
{
  bool mu__while_expr_419;  mu__while_expr_419 = (mu_i) <= (mu_pat13Set.mu_length);
...
mu__while_expr_419 = (mu_i) <= (mu_pat13Set.mu_length);
}
};
mu_enconcatPat13 (  );
mu_i = 1;
{
  bool mu__while_expr_421;  mu__while_expr_421 = (mu_i) <= (mu_pat14Set.mu_length);
...
mu__while_expr_421 = (mu_i) <= (mu_pat14Set.mu_length);
}
};
mu_aEncryptionPat14 (  );
mu_i = 1;
{
  bool mu__while_expr_423;  mu__while_expr_423 = (mu_i) <= (mu_pat15Set.mu_length);
...
mu__while_expr_423 = (mu_i) <= (mu_pat15Set.mu_length);
}
};
mu_enconcatPat15 (  );
}
...
mu_i = 1;
{
  bool mu__while_expr_425;  mu__while_expr_425 = (mu_i) <= (mu_pat3Set.mu_length);
...
mu__while_expr_425 = (mu_i) <= (mu_pat3Set.mu_length);
}
};
mu_enconcatPat3 (  );
mu_i = 1;
...
bool mu__boolexpr447;
  if (!((mu_roleAS[mu_i].mu_st) == (mu_AS4))) mu__boolexpr447 = FALSE ;
  else {
  mu__boolexpr447 = ((mu_ch[5].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr447)) mu__boolexpr446 = FALSE ;
  else {
  mu__boolexpr446 = (!(mu_roleAS[mu_i].mu_commit)) ; 
}
...
bool mu__boolexpr449;
  if (!((mu_roleAS[mu_i].mu_st) == (mu_AS4))) mu__boolexpr449 = FALSE ;
  else {
  mu__boolexpr449 = ((mu_ch[5].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr449)) mu__boolexpr448 = FALSE ;
  else {
  mu__boolexpr448 = (!(mu_roleAS[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr448) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr451;
  if (!((mu_roleAS[mu_i].mu_st) == (mu_AS3))) mu__boolexpr451 = FALSE ;
  else {
  mu__boolexpr451 = ((mu_ch[4].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr451)) mu__boolexpr450 = FALSE ;
  else {
  mu__boolexpr450 = (!(mu_roleAS[mu_i].mu_commit)) ; 
}
...
bool mu__boolexpr453;
  if (!((mu_roleAS[mu_i].mu_st) == (mu_AS3))) mu__boolexpr453 = FALSE ;
  else {
  mu__boolexpr453 = ((mu_ch[4].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr453)) mu__boolexpr452 = FALSE ;
  else {
  mu__boolexpr452 = (!(mu_roleAS[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr452) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr455;
  if (!(mu_matchAgent( mu_roleAS[mu_i].mu_locS, mu_roleAS[mu_i].mu_S ))) mu__boolexpr455 = FALSE ;
  else {
  mu__boolexpr455 = (mu_matchAgent( mu_roleAS[mu_i].mu_locC, mu_roleAS[mu_i].mu_C )) ; 
}
  if (!(mu__boolexpr455)) mu__boolexpr454 = FALSE ;
  else {
  mu__boolexpr454 = (mu_matchNonce( mu_roleAS[mu_i].mu_locN3, mu_roleAS[mu_i].mu_N3 )) ; 
}
if ( mu__boolexpr454 )
{
...
bool mu__boolexpr457;
  if (!((mu_roleAS[mu_i].mu_st) == (mu_AS2))) mu__boolexpr457 = FALSE ;
  else {
  mu__boolexpr457 = ((mu_ch[2].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr457)) mu__boolexpr456 = FALSE ;
  else {
  mu__boolexpr456 = (!(mu_roleAS[mu_i].mu_commit)) ; 
}
...
bool mu__boolexpr459;
  if (!((mu_roleAS[mu_i].mu_st) == (mu_AS2))) mu__boolexpr459 = FALSE ;
  else {
  mu__boolexpr459 = ((mu_ch[2].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr459)) mu__boolexpr458 = FALSE ;
  else {
  mu__boolexpr458 = (!(mu_roleAS[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr458) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr461;
  if (!((mu_roleAS[mu_i].mu_st) == (mu_AS1))) mu__boolexpr461 = FALSE ;
  else {
  mu__boolexpr461 = ((mu_ch[1].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr461)) mu__boolexpr460 = FALSE ;
  else {
  mu__boolexpr460 = (!(mu_roleAS[mu_i].mu_commit)) ; 
}
...
bool mu__boolexpr463;
  if (!((mu_roleAS[mu_i].mu_st) == (mu_AS1))) mu__boolexpr463 = FALSE ;
  else {
  mu__boolexpr463 = ((mu_ch[1].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr463)) mu__boolexpr462 = FALSE ;
  else {
  mu__boolexpr462 = (!(mu_roleAS[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr462) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr465;
  if (!(mu_matchAgent( mu_roleAS[mu_i].mu_locC, mu_roleAS[mu_i].mu_C ))) mu__boolexpr465 = FALSE ;
  else {
  mu__boolexpr465 = (mu_matchAgent( mu_roleAS[mu_i].mu_locS, mu_roleAS[mu_i].mu_S )) ; 
}
  if (!(mu__boolexpr465)) mu__boolexpr464 = FALSE ;
  else {
  mu__boolexpr464 = (mu_matchNonce( mu_roleAS[mu_i].mu_locN1, mu_roleAS[mu_i].mu_N1 )) ; 
}
if ( mu__boolexpr464 )
{
...
bool mu__boolexpr467;
  if (!((mu_roleC[mu_i].mu_st) == (mu_C4))) mu__boolexpr467 = FALSE ;
  else {
  mu__boolexpr467 = ((mu_ch[6].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr467)) mu__boolexpr466 = FALSE ;
  else {
  mu__boolexpr466 = (!(mu_roleC[mu_i].mu_commit)) ; 
}
...
bool mu__boolexpr469;
  if (!((mu_roleC[mu_i].mu_st) == (mu_C4))) mu__boolexpr469 = FALSE ;
  else {
  mu__boolexpr469 = ((mu_ch[6].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr469)) mu__boolexpr468 = FALSE ;
  else {
  mu__boolexpr468 = (!(mu_roleC[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr468) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr472;
  if (!(mu_matchAgent( mu_roleC[mu_i].mu_locS, mu_roleC[mu_i].mu_S ))) mu__boolexpr472 = FALSE ;
  else {
  mu__boolexpr472 = (mu_matchAgent( mu_roleC[mu_i].mu_locC, mu_roleC[mu_i].mu_C )) ; 
}
  if (!(mu__boolexpr472)) mu__boolexpr471 = FALSE ;
  else {
  mu__boolexpr471 = (mu_matchNonce( mu_roleC[mu_i].mu_locN2, mu_roleC[mu_i].mu_N2 )) ; 
}
  if (!(mu__boolexpr471)) mu__boolexpr470 = FALSE ;
  else {
  mu__boolexpr470 = (mu_matchAgent( mu_roleC[mu_i].mu_locC, mu_roleC[mu_i].mu_C )) ; 
}
if ( mu__boolexpr470 )
{
...
bool mu__boolexpr474;
  if (!((mu_roleC[mu_i].mu_st) == (mu_C3))) mu__boolexpr474 = FALSE ;
  else {
  mu__boolexpr474 = ((mu_ch[3].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr474)) mu__boolexpr473 = FALSE ;
  else {
  mu__boolexpr473 = (!(mu_roleC[mu_i].mu_commit)) ; 
}
...
bool mu__boolexpr476;
  if (!((mu_roleC[mu_i].mu_st) == (mu_C3))) mu__boolexpr476 = FALSE ;
  else {
  mu__boolexpr476 = ((mu_ch[3].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr476)) mu__boolexpr475 = FALSE ;
  else {
  mu__boolexpr475 = (!(mu_roleC[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr475) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr478;
  if (!((mu_roleC[mu_i].mu_st) == (mu_C2))) mu__boolexpr478 = FALSE ;
  else {
  mu__boolexpr478 = ((mu_ch[2].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr478)) mu__boolexpr477 = FALSE ;
  else {
  mu__boolexpr477 = (!(mu_roleC[mu_i].mu_commit)) ; 
}
...
bool mu__boolexpr480;
  if (!((mu_roleC[mu_i].mu_st) == (mu_C2))) mu__boolexpr480 = FALSE ;
  else {
  mu__boolexpr480 = ((mu_ch[2].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr480)) mu__boolexpr479 = FALSE ;
  else {
  mu__boolexpr479 = (!(mu_roleC[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr479) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr484;
  if (!(mu_matchAgent( mu_roleC[mu_i].mu_locAS, mu_roleC[mu_i].mu_AS ))) mu__boolexpr484 = FALSE ;
  else {
  mu__boolexpr484 = (mu_matchAgent( mu_roleC[mu_i].mu_locC, mu_roleC[mu_i].mu_C )) ; 
}
  if (!(mu__boolexpr484)) mu__boolexpr483 = FALSE ;
  else {
  mu__boolexpr483 = (mu_matchNonce( mu_roleC[mu_i].mu_locN1, mu_roleC[mu_i].mu_N1 )) ; 
}
  if (!(mu__boolexpr483)) mu__boolexpr482 = FALSE ;
  else {
  mu__boolexpr482 = (mu_matchAgent( mu_roleC[mu_i].mu_locS, mu_roleC[mu_i].mu_S )) ; 
}
  if (!(mu__boolexpr482)) mu__boolexpr481 = FALSE ;
  else {
  mu__boolexpr481 = (mu_matchAgent( mu_roleC[mu_i].mu_locAS, mu_roleC[mu_i].mu_AS )) ; 
}
if ( mu__boolexpr481 )
{
...
bool mu__boolexpr486;
  if (!((mu_roleC[mu_i].mu_st) == (mu_C1))) mu__boolexpr486 = FALSE ;
  else {
  mu__boolexpr486 = ((mu_ch[1].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr486)) mu__boolexpr485 = FALSE ;
  else {
  mu__boolexpr485 = (!(mu_roleC[mu_i].mu_commit)) ; 
}
...
bool mu__boolexpr488;
  if (!((mu_roleC[mu_i].mu_st) == (mu_C1))) mu__boolexpr488 = FALSE ;
  else {
  mu__boolexpr488 = ((mu_ch[1].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr488)) mu__boolexpr487 = FALSE ;
  else {
  mu__boolexpr487 = (!(mu_roleC[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr487) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr490;
  if (!((mu_roleS[mu_i].mu_st) == (mu_S4))) mu__boolexpr490 = FALSE ;
  else {
  mu__boolexpr490 = ((mu_ch[6].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr490)) mu__boolexpr489 = FALSE ;
  else {
  mu__boolexpr489 = (!(mu_roleS[mu_i].mu_commit)) ; 
}
...
bool mu__boolexpr492;
  if (!((mu_roleS[mu_i].mu_st) == (mu_S4))) mu__boolexpr492 = FALSE ;
  else {
  mu__boolexpr492 = ((mu_ch[6].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr492)) mu__boolexpr491 = FALSE ;
  else {
  mu__boolexpr491 = (!(mu_roleS[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr491) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr494;
  if (!((mu_roleS[mu_i].mu_st) == (mu_S3))) mu__boolexpr494 = FALSE ;
  else {
  mu__boolexpr494 = ((mu_ch[5].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr494)) mu__boolexpr493 = FALSE ;
  else {
  mu__boolexpr493 = (!(mu_roleS[mu_i].mu_commit)) ; 
}
    return mu__boolexpr493;
  }
...
bool mu__boolexpr496;
  if (!((mu_roleS[mu_i].mu_st) == (mu_S3))) mu__boolexpr496 = FALSE ;
  else {
  mu__boolexpr496 = ((mu_ch[5].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr496)) mu__boolexpr495 = FALSE ;
  else {
  mu__boolexpr495 = (!(mu_roleS[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr495) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr500;
  if (!(mu_matchAgent( mu_roleS[mu_i].mu_locAS, mu_roleS[mu_i].mu_AS ))) mu__boolexpr500 = FALSE ;
  else {
  mu__boolexpr500 = (mu_matchAgent( mu_roleS[mu_i].mu_locS, mu_roleS[mu_i].mu_S )) ; 
}
  if (!(mu__boolexpr500)) mu__boolexpr499 = FALSE ;
  else {
  mu__boolexpr499 = (mu_matchNonce( mu_roleS[mu_i].mu_locN3, mu_roleS[mu_i].mu_N3 )) ; 
}
  if (!(mu__boolexpr499)) mu__boolexpr498 = FALSE ;
  else {
  mu__boolexpr498 = (mu_matchAgent( mu_roleS[mu_i].mu_locC, mu_roleS[mu_i].mu_C )) ; 
}
  if (!(mu__boolexpr498)) mu__boolexpr497 = FALSE ;
  else {
  mu__boolexpr497 = (mu_matchAgent( mu_roleS[mu_i].mu_locAS, mu_roleS[mu_i].mu_AS )) ; 
}
if ( mu__boolexpr497 )
{
...
bool mu__boolexpr502;
  if (!((mu_roleS[mu_i].mu_st) == (mu_S2))) mu__boolexpr502 = FALSE ;
  else {
  mu__boolexpr502 = ((mu_ch[4].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr502)) mu__boolexpr501 = FALSE ;
  else {
  mu__boolexpr501 = (!(mu_roleS[mu_i].mu_commit)) ; 
}
...
bool mu__boolexpr504;
  if (!((mu_roleS[mu_i].mu_st) == (mu_S2))) mu__boolexpr504 = FALSE ;
  else {
  mu__boolexpr504 = ((mu_ch[4].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr504)) mu__boolexpr503 = FALSE ;
  else {
  mu__boolexpr503 = (!(mu_roleS[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr503) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr506;
  if (!((mu_roleS[mu_i].mu_st) == (mu_S1))) mu__boolexpr506 = FALSE ;
  else {
  mu__boolexpr506 = ((mu_ch[3].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr506)) mu__boolexpr505 = FALSE ;
  else {
  mu__boolexpr505 = (!(mu_roleS[mu_i].mu_commit)) ; 
}
...
bool mu__boolexpr508;
  if (!((mu_roleS[mu_i].mu_st) == (mu_S1))) mu__boolexpr508 = FALSE ;
  else {
  mu__boolexpr508 = ((mu_ch[3].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr508)) mu__boolexpr507 = FALSE ;
  else {
  mu__boolexpr507 = (!(mu_roleS[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr507) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr514;
  if (!(mu_matchAgent( mu_roleS[mu_i].mu_locC, mu_roleS[mu_i].mu_C ))) mu__boolexpr514 = FALSE ;
  else {
  mu__boolexpr514 = (mu_matchAgent( mu_roleS[mu_i].mu_locS, mu_roleS[mu_i].mu_S )) ; 
}
  if (!(mu__boolexpr514)) mu__boolexpr513 = FALSE ;
  else {
  mu__boolexpr513 = (mu_matchNonce( mu_roleS[mu_i].mu_locT, mu_roleS[mu_i].mu_T )) ; 
}
  if (!(mu__boolexpr513)) mu__boolexpr512 = FALSE ;
  else {
  mu__boolexpr512 = (mu_matchNonce( mu_roleS[mu_i].mu_locL, mu_roleS[mu_i].mu_L )) ; 
}
  if (!(mu__boolexpr512)) mu__boolexpr511 = FALSE ;
  else {
  mu__boolexpr511 = (mu_matchNonce( mu_roleS[mu_i].mu_locN2, mu_roleS[mu_i].mu_N2 )) ; 
}
  if (!(mu__boolexpr511)) mu__boolexpr510 = FALSE ;
  else {
  mu__boolexpr510 = (mu_matchAgent( mu_roleS[mu_i].mu_locS, mu_roleS[mu_i].mu_S )) ; 
}
  if (!(mu__boolexpr510)) mu__boolexpr509 = FALSE ;
  else {
  mu__boolexpr509 = (mu_matchAgent( mu_roleS[mu_i].mu_locC, mu_roleS[mu_i].mu_C )) ; 
}
if ( mu__boolexpr509 )
{
...
/********************
  Invariant records
 ********************/
int mu__invariant_515() // Invariant "auth1"
{
bool mu__quant516; 
mu__quant516 = TRUE;
{
...
bool mu__boolexpr517;
  if (!((mu_roleC[mu_i].mu_commit) == (mu_true))) mu__boolexpr517 = TRUE ;
  else {
bool mu__quant518; 
mu__quant518 = FALSE;
{
...
if ( ((mu_roleS[mu_i].mu_N2) == (mu_roleC[mu_j].mu_N2)) )
  { mu__quant518 = TRUE; break; }
};
};
  mu__boolexpr517 = (mu__quant518) ; 
}
if ( !(mu__boolexpr517) )
  { mu__quant516 = FALSE; break; }
};
};
return mu__quant516;
};

bool mu__condition_519() // Condition for Rule "auth1"
{
  return mu__invariant_515( );
}

/**** end rule declaration ****/

int mu__invariant_520() // Invariant "sec2"
{
bool mu__quant521; 
mu__quant521 = TRUE;
{
...
bool mu__boolexpr528;
  ...
  mu__boolexpr528 = ((mu_msgs[mu_i].mu_noncePart) == (mu_roleC[mu_j].mu_N2)) ; 
}
  if (!(mu__boolexpr528)) mu__boolexpr527 = FALSE ;
  else {
  mu__boolexpr527 = ((mu_roleC[mu_j].mu_C) != (mu_Intruder)) ; 
}
  if (!(mu__boolexpr527)) mu__boolexpr526 = FALSE ;
  else {
  mu__boolexpr526 = ((mu_roleC[mu_j].mu_S) != (mu_Intruder)) ; 
}
  if (!(mu__boolexpr526)) mu__boolexpr525 = FALSE ;
  else {
  mu__boolexpr525 = ((mu_roleS[mu_k].mu_S) != (mu_Intruder)) ; 
}
  if (!(mu__boolexpr525)) mu__boolexpr524 = TRUE ;
  else {
  mu__boolexpr524 = ((mu_Spy_known[mu_i]) == (mu_false)) ; 
}
if ( !(mu__boolexpr524) )
...
bool mu__condition_529() // Condition for Rule "sec2"
{
...
{"sec2", &mu__condition_529, NULL, },
{"auth1", &mu__condition_519, NULL, },
};
