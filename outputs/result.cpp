...
{
bool mu__boolexpr17;
  if (!((mu_msgs[mu_i].mu_msgType) == (mu_concat))) mu__boolexpr17 = FALSE ;
  else {
  mu__boolexpr17 = ((mu_msgs[mu_i].mu_length) == (2)) ; 
}
if ( mu__boolexpr17 )
{
bool mu__boolexpr18;
  if (!((mu_msgs[mu_i].mu_concatPart[1]) == (mu_i1))) mu__boolexpr18 = FALSE ;
  else {
  mu__boolexpr18 = ((mu_msgs[mu_i].mu_concatPart[2]) == (mu_i2)) ; 
}
if ( mu__boolexpr18 )
{
if (mu_i.isundefined())
...
{
bool mu__boolexpr19;
  if (!((mu_msgs[mu_i].mu_k.mu_encType) == (mu_PK))) mu__boolexpr19 = FALSE ;
  else {
  mu__boolexpr19 = ((mu_msgs[mu_i].mu_k.mu_ag) == (mu_BPk)) ; 
}
if ( mu__boolexpr19 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr22;
  if (!((mu_msgs[mu_i].mu_msgType) == (mu_key))) mu__boolexpr22 = FALSE ;
  else {
  mu__boolexpr22 = ((mu_msgs[mu_i].mu_k.mu_encType) == (mu_PK)) ; 
}
if ( mu__boolexpr22 )
{
...
{
bool mu__boolexpr23;
  if (!((mu_msgs[mu_i].mu_aencMsg) == (mu_i1))) mu__boolexpr23 = FALSE ;
  else {
  mu__boolexpr23 = ((mu_msgs[mu_i].mu_aencKey) == (mu_i2)) ; 
}
if ( mu__boolexpr23 )
{
mu_index = mu_i;
...
bool mu__boolexpr28;
  ...
  mu__boolexpr28 = ((mu_msgs[mu_i].mu_length) == (3)) ; 
}
if ( mu__boolexpr28 )
{
bool mu__boolexpr29;
...
void mu_constructSpat6(const mu_1_NonceType& mu_Na, const mu_1_NonceType& mu_Nb, const mu_1_AgentType& mu_B, mu_1_indexType& mu_num)
{
/*** Variable declaration ***/
mu_1_indexType mu_i("i",0);
...
bool mu__boolexpr35;
  ...
  mu__boolexpr35 = ((mu_msgs[mu_i].mu_length) == (3)) ; 
}
if ( mu__boolexpr35 )
{
bool mu__boolexpr36;
bool mu__boolexpr37;
  if (!((mu_msgs[mu_i].mu_concatPart[1]) == (mu_i1))) mu__boolexpr37 = FALSE ;
  else {
  mu__boolexpr37 = ((mu_msgs[mu_i].mu_concatPart[2]) == (mu_i2)) ; 
}
  if (!(mu__boolexpr37)) mu__boolexpr36 = FALSE ;
  else {
  mu__boolexpr36 = ((mu_msgs[mu_i].mu_concatPart[3]) == (mu_i3)) ; 
}
if ( mu__boolexpr36 )
{
if (mu_i.isundefined())
...
void mu_constructSpat7(const mu_1_NonceType& mu_Na, const mu_1_NonceType& mu_Nb, const mu_1_AgentType& mu_B, const mu_1_AgentType& mu_APk, mu_1_indexType& mu_num)
{
/*** Variable declaration ***/
mu_1_indexType mu_i("i",0);
...
mu_index = 0;
mu_constructSpat6 ( mu_Na, mu_Nb, mu_B, mu_i1 );
...
{
bool mu__boolexpr43;
  if (!((mu_msgs[mu_i].mu_aencMsg) == (mu_i1))) mu__boolexpr43 = FALSE ;
  else {
  mu__boolexpr43 = ((mu_msgs[mu_i].mu_aencKey) == (mu_i2)) ; 
}
if ( mu__boolexpr43 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr47;
  if (!((mu_msgs[mu_i].mu_aencMsg) == (mu_i1))) mu__boolexpr47 = FALSE ;
  else {
  mu__boolexpr47 = ((mu_msgs[mu_i].mu_aencKey) == (mu_i2)) ; 
}
if ( mu__boolexpr47 )
{
if (mu_i.isundefined())
...
bool mu__boolexpr51;
bool mu__boolexpr52;
  if (!((mu_msg.mu_msgType) == (mu_agent))) mu__boolexpr52 = FALSE ;
  else {
  mu__boolexpr52 = ((mu_msgs[mu_i].mu_ag) == (mu_msg.mu_ag)) ; 
}
  if (mu__boolexpr52) mu__boolexpr51 = TRUE ;
  else {
bool mu__boolexpr53;
  if (!((mu_msg.mu_msgType) == (mu_nonce))) mu__boolexpr53 = FALSE ;
  else {
  mu__boolexpr53 = ((mu_msgs[mu_i].mu_noncePart) == (mu_msg.mu_noncePart)) ; 
}
...
bool mu__boolexpr55;
  if (!((mu_msgs[mu_i].mu_k.mu_encType) == (mu_msg.mu_k.mu_encType))) mu__boolexpr55 = FALSE ;
  else {
  mu__boolexpr55 = ((mu_msgs[mu_i].mu_k.mu_ag) == (mu_msg.mu_k.mu_ag)) ; 
}
  mu__boolexpr54 = (mu__boolexpr55) ; 
}
  mu__boolexpr50 = (mu__boolexpr54) ; 
}
  if (mu__boolexpr50) mu__boolexpr49 = TRUE ;
  else {
bool mu__boolexpr56;
  if (!((mu_msg.mu_msgType) == (mu_aenc))) mu__boolexpr56 = FALSE ;
  else {
bool mu__boolexpr57;
  if (!((mu_msgs[mu_i].mu_aencMsg) == (mu_msg.mu_aencMsg))) mu__boolexpr57 = FALSE ;
  else {
  mu__boolexpr57 = ((mu_msgs[mu_i].mu_aencKey) == (mu_msg.mu_aencKey)) ; 
}
  mu__boolexpr56 = (mu__boolexpr57) ; 
}
  mu__boolexpr49 = (mu__boolexpr56) ; 
}
  if (mu__boolexpr49) mu__boolexpr48 = TRUE ;
  else {
bool mu__boolexpr58;
  if (!((mu_msg.mu_msgType) == (mu_senc))) mu__boolexpr58 = FALSE ;
  else {
bool mu__boolexpr59;
  if (!((mu_msgs[mu_i].mu_sencMsg) == (mu_msg.mu_sencMsg))) mu__boolexpr59 = FALSE ;
  else {
  mu__boolexpr59 = ((mu_msgs[mu_i].mu_sencKey) == (mu_msg.mu_sencKey)) ; 
}
  mu__boolexpr58 = (mu__boolexpr59) ; 
}
  mu__boolexpr48 = (mu__boolexpr58) ; 
}
if ( mu__boolexpr48 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr60;
  if (!((mu_msg.mu_msgType) == (mu_concat))) mu__boolexpr60 = FALSE ;
  else {
  mu__boolexpr60 = ((mu_msg.mu_length) == (mu_msgs[mu_i].mu_length)) ; 
}
if ( mu__boolexpr60 )
{
...
mu_flag = mu_true;
{
  bool mu__while_expr_62;  mu__while_expr_62 = (mu_j) > (0);
...
mu_i = 1;
{
  bool mu__while_expr_64;  mu__while_expr_64 = (mu_i) < (mu_msg.mu_length);
...
mu__while_expr_64 = (mu_i) < (mu_msg.mu_length);
}
};
mu_printMsg ( mu_msgs[mu_msg.mu_concatPart[mu_i]] );
cout << ")";
...
{
bool mu__boolexpr65;
  if (!((mu_msgs[mu_i].mu_msgType) == (mu_agent))) mu__boolexpr65 = FALSE ;
  else {
  mu__boolexpr65 = ((mu_msgs[mu_i].mu_ag) == (mu_msg.mu_ag)) ; 
}
if ( mu__boolexpr65 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr66;
  if (!((mu_msgs[mu_i].mu_msgType) == (mu_nonce))) mu__boolexpr66 = FALSE ;
  else {
  mu__boolexpr66 = ((mu_msgs[mu_i].mu_noncePart) == (mu_msg.mu_noncePart)) ; 
}
if ( mu__boolexpr66 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr67;
  if (!((mu_msgs[mu_i].mu_msgType) == (mu_key))) mu__boolexpr67 = FALSE ;
  else {
bool mu__boolexpr68;
  if (!((mu_msgs[mu_i].mu_k.mu_encType) == (mu_msg.mu_k.mu_encType))) mu__boolexpr68 = FALSE ;
  else {
  mu__boolexpr68 = ((mu_msgs[mu_i].mu_k.mu_ag) == (mu_msg.mu_k.mu_ag)) ; 
}
...
{
bool mu__boolexpr69;
  if (!((mu_msgs[mu_i].mu_msgType) == (mu_aenc))) mu__boolexpr69 = FALSE ;
  else {
bool mu__boolexpr70;
  if (!((mu_msgs[mu_i].mu_aencKey) == (mu_msg.mu_aencKey))) mu__boolexpr70 = FALSE ;
  else {
  mu__boolexpr70 = ((mu_msgs[mu_i].mu_aencMsg) == (mu_msg.mu_aencMsg)) ; 
}
...
{
bool mu__boolexpr71;
  if (!((mu_msgs[mu_i].mu_msgType) == (mu_senc))) mu__boolexpr71 = FALSE ;
  else {
bool mu__boolexpr72;
  if (!((mu_msgs[mu_i].mu_sencKey) == (mu_msg.mu_sencKey))) mu__boolexpr72 = FALSE ;
  else {
  mu__boolexpr72 = ((mu_msgs[mu_i].mu_sencMsg) == (mu_msg.mu_sencMsg)) ; 
}
...
bool mu__boolexpr74;
  if (!((mu_msgs[mu_i].mu_concatPart[1]) == (mu_msg.mu_concatPart[1]))) mu__boolexpr74 = FALSE ;
  else {
  mu__boolexpr74 = ((mu_msgs[mu_i].mu_concatPart[2]) == (mu_msg.mu_concatPart[2])) ; 
}
...
{
bool mu__boolexpr77;
  if (!((mu_msgs[mu_i].mu_aencMsg) == (mu_msgNo3))) mu__boolexpr77 = FALSE ;
  else {
...
{
bool mu__boolexpr81;
  if (!((mu_msgs[mu_i].mu_aencMsg) == (mu_msgNo6))) mu__boolexpr81 = FALSE ;
  else {
  mu__boolexpr81 = ((mu_msgs[mu_i].mu_aencKey) == (mu_msgNo4)) ; 
}
if ( mu__boolexpr81 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr82;
  if (!((mu_msgs[mu_i].mu_aencMsg) == (mu_msgNo1))) mu__boolexpr82 = FALSE ;
  else {
  mu__boolexpr82 = ((mu_msgs[mu_i].mu_aencKey) == (mu_msgNo4)) ; 
}
if ( mu__boolexpr82 )
{
mu_index = mu_i;
...
bool mu__boolexpr83;
  if (!((mu_msgNo) != (0))) mu__boolexpr83 = FALSE ;
  else {
  mu__boolexpr83 = ((mu_PatnSet.mu_content[mu_i]) == (mu_msgNo)) ; 
}
if ( mu__boolexpr83 )
{
mu_flag = mu_true;
...
bool mu__boolexpr84;
  if (!((mu_m1.mu_msgType) == (mu_agent))) mu__boolexpr84 = FALSE ;
  else {
  mu__boolexpr84 = ((mu_m2.mu_msgType) == (mu_agent)) ; 
}
if ( mu__boolexpr84 )
{
...
{
bool mu__boolexpr85;
  if (!((mu_m1.mu_msgType) == (mu_nonce))) mu__boolexpr85 = FALSE ;
  else {
  mu__boolexpr85 = ((mu_m2.mu_msgType) == (mu_nonce)) ; 
}
if ( mu__boolexpr85 )
{
...
{
bool mu__boolexpr86;
  if (!((mu_m1.mu_msgType) == (mu_key))) mu__boolexpr86 = FALSE ;
  else {
  mu__boolexpr86 = ((mu_m2.mu_msgType) == (mu_key)) ; 
}
if ( mu__boolexpr86 )
{
bool mu__boolexpr87;
  if (!((mu_m1.mu_k.mu_encType) == (mu_m2.mu_k.mu_encType))) mu__boolexpr87 = FALSE ;
  else {
  mu__boolexpr87 = (mu_matchAgent( mu_m1.mu_k.mu_ag, mu_m2.mu_k.mu_ag )) ; 
}
...
{
bool mu__boolexpr88;
  if (!((mu_m1.mu_msgType) == (mu_aenc))) mu__boolexpr88 = FALSE ;
  else {
  mu__boolexpr88 = ((mu_m2.mu_msgType) == (mu_aenc)) ; 
}
if ( mu__boolexpr88 )
{
bool mu__boolexpr89;
  if (!(mu_match( mu_msgs[mu_m1.mu_aencMsg], mu_msgs[mu_m2.mu_aencMsg] ))) mu__boolexpr89 = FALSE ;
  else {
  mu__boolexpr89 = (mu_match( mu_msgs[mu_m1.mu_aencKey], mu_msgs[mu_m2.mu_aencKey] )) ; 
}
...
{
bool mu__boolexpr90;
  if (!((mu_m1.mu_msgType) == (mu_senc))) mu__boolexpr90 = FALSE ;
  else {
  mu__boolexpr90 = ((mu_m2.mu_msgType) == (mu_senc)) ; 
}
if ( mu__boolexpr90 )
{
bool mu__boolexpr91;
  if (!(mu_match( mu_msgs[mu_m1.mu_sencMsg], mu_msgs[mu_m2.mu_sencMsg] ))) mu__boolexpr91 = FALSE ;
  else {
  mu__boolexpr91 = (mu_match( mu_msgs[mu_m1.mu_sencKey], mu_msgs[mu_m2.mu_sencKey] )) ; 
}
...
bool mu__boolexpr92;
bool mu__boolexpr93;
  if (!((mu_m1.mu_msgType) == (mu_concat))) mu__boolexpr93 = FALSE ;
  else {
  mu__boolexpr93 = ((mu_m2.mu_msgType) == (mu_concat)) ; 
}
  if (!(mu__boolexpr93)) mu__boolexpr92 = FALSE ;
  else {
  mu__boolexpr92 = ((mu_m1.mu_length) == (mu_m2.mu_length)) ; 
}
if ( mu__boolexpr92 )
{
...
{
  bool mu__while_expr_95;  mu__while_expr_95 = mu__boolexpr96;
...
{
bool mu__boolexpr97;
  if (!(mu_concatFlag)) mu__boolexpr97 = FALSE ;
  else {
  mu__boolexpr97 = (mu_match( mu_msgs[mu_m1.mu_concatPart[mu_i]], mu_msgs[mu_m2.mu_concatPart[mu_i]] )) ; 
}
mu_concatFlag = mu__boolexpr97;
mu_i = (mu_i) - (1);
};
bool mu__boolexpr98;
  if (!((mu_i) > (0))) mu__boolexpr98 = FALSE ;
  else {
  mu__boolexpr98 = (mu_concatFlag) ; 
}
mu__while_expr_95 = mu__boolexpr98;
}
};
...
mu_i = 1;
{
  bool mu__while_expr_100;  mu__while_expr_100 = (mu_i) < ((mu_sPatnSet.mu_length) + (1));
...
mu__while_expr_100 = (mu_i) < ((mu_sPatnSet.mu_length) + (1));
}
};
return mu_flag;
...
/*** Variable declaration ***/
mu_1_indexType mu_i2("i2",8);

/*** Variable declaration ***/
mu_1_indexType mu_concatMsgNo("concatMsgNo",16);

mu_i1 = 1;
{
  bool mu__while_expr_102;  mu__while_expr_102 = (mu_i1) <= (mu_pat1Set.mu_length);
...
mu_i2 = 1;
{
  bool mu__while_expr_104;  mu__while_expr_104 = (mu_i2) <= (mu_pat2Set.mu_length);
...
bool mu__boolexpr105;
  if (!(mu_matchPat( mu_msgs[mu_construct3By12( mu_pat1Set.mu_content[mu_i1], mu_pat2Set.mu_content[mu_i2] )], mu_sPat3Set ))) mu__boolexpr105 = FALSE ;
  else {
  mu__boolexpr105 = (!(mu_Spy_known[mu_construct3By12( mu_pat1Set.mu_content[mu_i1], mu_pat2Set.mu_content[mu_i2] )])) ; 
}
if ( mu__boolexpr105 )
{
...
mu__while_expr_104 = (mu_i2) <= (mu_pat2Set.mu_length);
}
};
};
mu__while_expr_102 = (mu_i1) <= (mu_pat1Set.mu_length);
}
};
};
/*** end procedure declaration ***/

void mu_aDeryptionPat5(mu_1_Message& mu_msg)
{
/*** Variable declaration ***/
mu_1_Message mu_key_inv("key_inv",0);
...
/*** Variable declaration ***/
mu_1_indexType mu_encMsgNo("encMsgNo",16);

mu_i = 1;
{
  bool mu__while_expr_107;  mu__while_expr_107 = (mu_i) < (mu_pat3Set.mu_length);
...
mu_j = 1;
{
  bool mu__while_expr_109;  mu__while_expr_109 = (mu_j) < (mu_pat4Set.mu_length);
...
bool mu__boolexpr110;
  if (!(mu_matchPat( mu_msgs[mu_construct5By34( mu_pat3Set.mu_content[mu_i], mu_pat4Set.mu_content[mu_j] )], mu_sPat5Set ))) mu__boolexpr110 = FALSE ;
  else {
  mu__boolexpr110 = (!(mu_Spy_known[mu_construct5By34( mu_pat3Set.mu_content[mu_i], mu_pat4Set.mu_content[mu_j] )])) ; 
}
if ( mu__boolexpr110 )
{
...
mu__while_expr_109 = (mu_j) < (mu_pat4Set.mu_length);
}
};
};
mu__while_expr_107 = (mu_i) < (mu_pat3Set.mu_length);
}
};
};
/*** end procedure declaration ***/
...
/*** Variable declaration ***/
mu_1_indexType mu_i3("i3",16);

/*** Variable declaration ***/
mu_1_indexType mu_concatMsgNo("concatMsgNo",24);

mu_i1 = 1;
{
  bool mu__while_expr_112;  mu__while_expr_112 = (mu_i1) <= (mu_pat1Set.mu_length);
...
mu_i2 = 1;
{
  bool mu__while_expr_114;  mu__while_expr_114 = (mu_i2) <= (mu_pat1Set.mu_length);
...
mu_i3 = 1;
{
  bool mu__while_expr_116;  mu__while_expr_116 = (mu_i3) <= (mu_pat2Set.mu_length);
...
bool mu__boolexpr117;
  if (!(mu_matchPat( mu_msgs[mu_construct6By112( mu_pat1Set.mu_content[mu_i1], mu_pat1Set.mu_content[mu_i2], mu_pat2Set.mu_content[mu_i3] )], mu_sPat6Set ))) mu__boolexpr117 = FALSE ;
  else {
  mu__boolexpr117 = (!(mu_Spy_known[mu_construct6By112( mu_pat1Set.mu_content[mu_i1], mu_pat1Set.mu_content[mu_i2], mu_pat2Set.mu_content[mu_i3] )])) ; 
}
if ( mu__boolexpr117 )
{
mu_concatMsgNo = mu_construct6By112( mu_pat1Set.mu_content[mu_i1], mu_pat1Set.mu_content[mu_i2], mu_pat2Set.mu_content[mu_i3] );
...
mu__while_expr_116 = (mu_i3) <= (mu_pat2Set.mu_length);
}
};
};
mu__while_expr_114 = (mu_i2) <= (mu_pat1Set.mu_length);
}
};
};
mu__while_expr_112 = (mu_i1) <= (mu_pat1Set.mu_length);
}
};
};
/*** end procedure declaration ***/
...
mu_i = 1;
{
  bool mu__while_expr_119;  mu__while_expr_119 = (mu_i) < (mu_pat6Set.mu_length);
...
mu_j = 1;
{
  bool mu__while_expr_121;  mu__while_expr_121 = (mu_j) < (mu_pat4Set.mu_length);
...
bool mu__boolexpr122;
  if (!(mu_matchPat( mu_msgs[mu_construct7By64( mu_pat6Set.mu_content[mu_i], mu_pat4Set.mu_content[mu_j] )], mu_sPat7Set ))) mu__boolexpr122 = FALSE ;
  else {
  mu__boolexpr122 = (!(mu_Spy_known[mu_construct7By64( mu_pat6Set.mu_content[mu_i], mu_pat4Set.mu_content[mu_j] )])) ; 
}
if ( mu__boolexpr122 )
{
if ( (mu_msgs[mu_pat4Set.mu_content[mu_j]].mu_k.mu_encType) == (mu_PK) )
...
mu__while_expr_121 = (mu_j) < (mu_pat4Set.mu_length);
}
};
};
mu__while_expr_119 = (mu_i) < (mu_pat6Set.mu_length);
}
};
};
/*** end procedure declaration ***/
...
mu_i = 1;
{
  bool mu__while_expr_124;  mu__while_expr_124 = (mu_i) < (mu_pat1Set.mu_length);
...
mu_j = 1;
{
  bool mu__while_expr_126;  mu__while_expr_126 = (mu_j) < (mu_pat4Set.mu_length);
int mu__counter_125 = 0;
while (mu__while_expr_126) {
if ( ++mu__counter_125 > args->loopmax.value )
  Error.Error("Too many iterations in while loop.");
{
bool mu__boolexpr127;
  if (!(mu_matchPat( mu_msgs[mu_construct8By14( mu_pat1Set.mu_content[mu_i], mu_pat4Set.mu_content[mu_j] )], mu_sPat8Set ))) mu__boolexpr127 = FALSE ;
  else {
  mu__boolexpr127 = (!(mu_Spy_known[mu_construct8By14( mu_pat1Set.mu_content[mu_i], mu_pat4Set.mu_content[mu_j] )])) ; 
}
if ( mu__boolexpr127 )
{
if ( (mu_msgs[mu_pat4Set.mu_content[mu_j]].mu_k.mu_encType) == (mu_PK) )
...
mu__while_expr_126 = (mu_j) < (mu_pat4Set.mu_length);
}
};
};
mu__while_expr_124 = (mu_i) < (mu_pat1Set.mu_length);
}
};
};
/*** end procedure declaration ***/
...
bool mu__boolexpr131;
  ...
  mu__boolexpr131 = ((mu_i) <= (mu_pat8Set.mu_length)) ; 
}
  if (!(mu__boolexpr131)) mu__boolexpr130 = FALSE ;
  else {
  mu__boolexpr130 = ((mu_pat8Set.mu_content[mu_i]) != (0)) ; 
}
  ...
  mu__boolexpr128 = (mu_matchPat( mu_msgs[mu_pat8Set.mu_content[mu_i]], mu_sPat8Set )) ; 
}
...
bool mu__boolexpr135;
  if (!((mu_ch[3].mu_empty) == (mu_true))) mu__boolexpr135 = FALSE ;
  else {
  mu__boolexpr135 = ((mu_i) <= (mu_pat8Set.mu_length)) ; 
}
  if (!(mu__boolexpr135)) mu__boolexpr134 = FALSE ;
  else {
  mu__boolexpr134 = ((mu_pat8Set.mu_content[mu_i]) != (0)) ; 
}
  ...
  mu__boolexpr132 = (mu_matchPat( mu_msgs[mu_pat8Set.mu_content[mu_i]], mu_sPat8Set )) ; 
}
	      if (mu__boolexpr132) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr143;
  if (!((mu_ch[2].mu_empty) == (mu_true))) mu__boolexpr143 = FALSE ;
  else {
  mu__boolexpr143 = ((mu_i) <= (mu_pat7Set.mu_length)) ; 
}
  ...
  mu__boolexpr140 = (mu_matchPat( mu_msgs[mu_pat7Set.mu_content[mu_i]], mu_sPat7Set )) ; 
}
	      if (mu__boolexpr140) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr147;
  if (!((mu_ch[1].mu_empty) == (mu_true))) mu__boolexpr147 = FALSE ;
  else {
  mu__boolexpr147 = ((mu_i) <= (mu_pat5Set.mu_length)) ; 
}
  if (!(mu__boolexpr147)) mu__boolexpr146 = FALSE ;
  else {
  mu__boolexpr146 = ((mu_pat5Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr146)) mu__boolexpr145 = FALSE ;
  else {
  mu__boolexpr145 = (mu_Spy_known[mu_pat5Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr145)) mu__boolexpr144 = FALSE ;
  else {
  mu__boolexpr144 = (mu_matchPat( mu_msgs[mu_pat5Set.mu_content[mu_i]], mu_sPat5Set )) ; 
}
...
bool mu__boolexpr151;
  if (!((mu_ch[1].mu_empty) == (mu_true))) mu__boolexpr151 = FALSE ;
  else {
  mu__boolexpr151 = ((mu_i) <= (mu_pat5Set.mu_length)) ; 
}
  if (!(mu__boolexpr151)) mu__boolexpr150 = FALSE ;
  else {
  mu__boolexpr150 = ((mu_pat5Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr150)) mu__boolexpr149 = FALSE ;
  else {
  mu__boolexpr149 = (mu_Spy_known[mu_pat5Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr149)) mu__boolexpr148 = FALSE ;
  else {
  mu__boolexpr148 = (mu_matchPat( mu_msgs[mu_pat5Set.mu_content[mu_i]], mu_sPat5Set )) ; 
}
	      if (mu__boolexpr148) {
		if ( ( TRUE  ) )
		  return;
...
mu_i = 1;
{
  bool mu__while_expr_153;  mu__while_expr_153 = (mu_i) <= (mu_pat3Set.mu_length);
...
mu__while_expr_153 = (mu_i) <= (mu_pat3Set.mu_length);
}
};
mu_i = 1;
{
  bool mu__while_expr_155;  mu__while_expr_155 = (mu_i) <= (mu_pat5Set.mu_length);
int mu__counter_154 = 0;
while (mu__while_expr_155) {
if ( ++mu__counter_154 > args->loopmax.value )
  Error.Error("Too many iterations in while loop.");
{
mu_aDeryptionPat5 ( mu_msgs[mu_pat5Set.mu_content[mu_i]] );
mu_aEncryptionPat5 (  );
mu_i = (mu_i) + (1);
};
mu__while_expr_155 = (mu_i) <= (mu_pat5Set.mu_length);
}
};
mu_i = 1;
{
  bool mu__while_expr_157;  mu__while_expr_157 = (mu_i) <= (mu_pat6Set.mu_length);
...
mu__while_expr_157 = (mu_i) <= (mu_pat6Set.mu_length);
}
};
mu_i = 1;
{
...
mu_i = 1;
{
  bool mu__while_expr_161;  mu__while_expr_161 = (mu_i) <= (mu_pat8Set.mu_length);
...
mu__while_expr_161 = (mu_i) <= (mu_pat8Set.mu_length);
}
};
}
...
mu_i = 1;
{
  bool mu__while_expr_163;  mu__while_expr_163 = (mu_i) <= (mu_pat3Set.mu_length);
...
mu__while_expr_163 = (mu_i) <= (mu_pat3Set.mu_length);
}
};
mu_i = 1;
{
  bool mu__while_expr_165;  mu__while_expr_165 = (mu_i) <= (mu_pat5Set.mu_length);
...
mu__while_expr_165 = (mu_i) <= (mu_pat5Set.mu_length);
}
};
mu_i = 1;
{
  bool mu__while_expr_167;  mu__while_expr_167 = (mu_i) <= (mu_pat6Set.mu_length);
...
mu__while_expr_167 = (mu_i) <= (mu_pat6Set.mu_length);
}
};
mu_i = 1;
{
  bool mu__while_expr_169;  mu__while_expr_169 = (mu_i) <= (mu_pat7Set.mu_length);
int mu__counter_168 = 0;
while (mu__while_expr_169) {
if ( ++mu__counter_168 > args->loopmax.value )
  Error.Error("Too many iterations in while loop.");
{
mu_aDeryptionPat7 ( mu_msgs[mu_pat7Set.mu_content[mu_i]] );
mu_aEncryptionPat7 (  );
...
mu__while_expr_169 = (mu_i) <= (mu_pat7Set.mu_length);
}
};
mu_i = 1;
{
  bool mu__while_expr_171;  mu__while_expr_171 = (mu_i) <= (mu_pat8Set.mu_length);
...
mu__while_expr_171 = (mu_i) <= (mu_pat8Set.mu_length);
}
};
}
...
mu_i = 1;
{
  bool mu__while_expr_173;  mu__while_expr_173 = (mu_i) <= (mu_pat3Set.mu_length);
...
mu__while_expr_173 = (mu_i) <= (mu_pat3Set.mu_length);
}
};
mu_i = 1;
{
  bool mu__while_expr_175;  mu__while_expr_175 = (mu_i) <= (mu_pat5Set.mu_length);
...
mu__while_expr_175 = (mu_i) <= (mu_pat5Set.mu_length);
}
};
mu_i = 1;
{
  bool mu__while_expr_177;  mu__while_expr_177 = (mu_i) <= (mu_pat6Set.mu_length);
...
mu__while_expr_177 = (mu_i) <= (mu_pat6Set.mu_length);
}
};
mu_i = 1;
{
  bool mu__while_expr_179;  mu__while_expr_179 = (mu_i) <= (mu_pat7Set.mu_length);
...
mu__while_expr_179 = (mu_i) <= (mu_pat7Set.mu_length);
}
};
mu_i = 1;
{
  bool mu__while_expr_181;  mu__while_expr_181 = (mu_i) <= (mu_pat8Set.mu_length);
...
mu__while_expr_181 = (mu_i) <= (mu_pat8Set.mu_length);
}
};
}
...
bool mu__boolexpr182;
  if (!((mu_roleB[mu_i].mu_st) == (mu_B3))) mu__boolexpr182 = FALSE ;
  else {
  mu__boolexpr182 = ((mu_ch[3].mu_empty) == (mu_false)) ; 
}
...
bool mu__boolexpr183;
  if (!((mu_roleB[mu_i].mu_st) == (mu_B3))) mu__boolexpr183 = FALSE ;
  else {
  mu__boolexpr183 = ((mu_ch[3].mu_empty) == (mu_false)) ; 
}
	      if (mu__boolexpr183) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr184;
  if (!(mu_matchNonce( mu_roleB[mu_i].mu_locNb, mu_roleB[mu_i].mu_Nb ))) mu__boolexpr184 = FALSE ;
  else {
  mu__boolexpr184 = (mu_matchAgent( mu_roleB[mu_i].mu_locB, mu_roleB[mu_i].mu_B )) ; 
}
if ( mu__boolexpr184 )
{
mu_ch[3].mu_empty = mu_true;
...
bool mu__boolexpr185;
  if (!((mu_roleB[mu_i].mu_st) == (mu_B2))) mu__boolexpr185 = FALSE ;
  else {
  mu__boolexpr185 = ((mu_ch[2].mu_empty) == (mu_true)) ; 
}
...
bool mu__boolexpr186;
  if (!((mu_roleB[mu_i].mu_st) == (mu_B2))) mu__boolexpr186 = FALSE ;
  else {
  mu__boolexpr186 = ((mu_ch[2].mu_empty) == (mu_true)) ; 
}
	      if (mu__boolexpr186) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr187;
  if (!((mu_roleB[mu_i].mu_st) == (mu_B1))) mu__boolexpr187 = FALSE ;
  else {
  mu__boolexpr187 = ((mu_ch[1].mu_empty) == (mu_false)) ; 
}
...
bool mu__boolexpr188;
  if (!((mu_roleB[mu_i].mu_st) == (mu_B1))) mu__boolexpr188 = FALSE ;
  else {
  mu__boolexpr188 = ((mu_ch[1].mu_empty) == (mu_false)) ; 
}
	      if (mu__boolexpr188) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr190;
  if (!(mu_matchNonce( mu_roleB[mu_i].mu_locNa, mu_roleB[mu_i].mu_Na ))) mu__boolexpr190 = FALSE ;
  else {
  mu__boolexpr190 = (mu_matchAgent( mu_roleB[mu_i].mu_locA, mu_roleB[mu_i].mu_A )) ; 
}
...
bool mu__boolexpr191;
  if (!((mu_roleA[mu_i].mu_st) == (mu_A3))) mu__boolexpr191 = FALSE ;
  else {
  mu__boolexpr191 = ((mu_ch[3].mu_empty) == (mu_true)) ; 
}
...
bool mu__boolexpr192;
  if (!((mu_roleA[mu_i].mu_st) == (mu_A3))) mu__boolexpr192 = FALSE ;
  else {
  mu__boolexpr192 = ((mu_ch[3].mu_empty) == (mu_true)) ; 
}
	      if (mu__boolexpr192) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr193;
  if (!((mu_roleA[mu_i].mu_st) == (mu_A2))) mu__boolexpr193 = FALSE ;
  else {
  mu__boolexpr193 = ((mu_ch[2].mu_empty) == (mu_false)) ; 
}
...
bool mu__boolexpr194;
  if (!((mu_roleA[mu_i].mu_st) == (mu_A2))) mu__boolexpr194 = FALSE ;
  else {
  mu__boolexpr194 = ((mu_ch[2].mu_empty) == (mu_false)) ; 
}
	      if (mu__boolexpr194) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr197;
  if (!(mu_matchNonce( mu_roleA[mu_i].mu_locNa, mu_roleA[mu_i].mu_Na ))) mu__boolexpr197 = FALSE ;
  else {
  mu__boolexpr197 = (mu_matchNonce( mu_roleA[mu_i].mu_locNb, mu_roleA[mu_i].mu_Nb )) ; 
}
  if (!(mu__boolexpr197)) mu__boolexpr196 = FALSE ;
  else {
  mu__boolexpr196 = (mu_matchAgent( mu_roleA[mu_i].mu_locB, mu_roleA[mu_i].mu_B )) ; 
}
  if (!(mu__boolexpr196)) mu__boolexpr195 = FALSE ;
  else {
  mu__boolexpr195 = (mu_matchAgent( mu_roleA[mu_i].mu_locA, mu_roleA[mu_i].mu_A )) ; 
}
if ( mu__boolexpr195 )
{
mu_ch[2].mu_empty = mu_true;
...
bool mu__boolexpr198;
  if (!((mu_roleA[mu_i].mu_st) == (mu_A1))) mu__boolexpr198 = FALSE ;
  else {
  mu__boolexpr198 = ((mu_ch[1].mu_empty) == (mu_true)) ; 
}
...
bool mu__boolexpr199;
  if (!((mu_roleA[mu_i].mu_st) == (mu_A1))) mu__boolexpr199 = FALSE ;
  else {
  mu__boolexpr199 = ((mu_ch[1].mu_empty) == (mu_true)) ; 
}
	      if (mu__boolexpr199) {
		if ( ( TRUE  ) )
		  return;
...
bool Condition(unsigned r)
{
  ...
  if (r>=48 && r<=48) return R3.Condition(r-48);
  if (r>=49 && r<=49) return R4.Condition(r-49);
  if (r>=50 && r<=50) return R5.Condition(r-50);
  if (r>=51 && r<=51) return R6.Condition(r-51);
  if (r>=52 && r<=52) return R7.Condition(r-52);
  if (r>=53 && r<=53) return R8.Condition(r-53);
  if (r>=54 && r<=54) return R9.Condition(r-54);
  if (r>=55 && r<=55) return R10.Condition(r-55);
  if (r>=56 && r<=56) return R11.Condition(r-56);
...
void Code(unsigned r)
{
  ...
  if (r>=48 && r<=48) { R3.Code(r-48); return; } 
  if (r>=49 && r<=49) { R4.Code(r-49); return; } 
  if (r>=50 && r<=50) { R5.Code(r-50); return; } 
  if (r>=51 && r<=51) { R6.Code(r-51); return; } 
  if (r>=52 && r<=52) { R7.Code(r-52); return; } 
  if (r>=53 && r<=53) { R8.Code(r-53); return; } 
  if (r>=54 && r<=54) { R9.Code(r-54); return; } 
  if (r>=55 && r<=55) { R10.Code(r-55); return; } 
  if (r>=56 && r<=56) { R11.Code(r-56); return; } 
}
int Priority(unsigned short r)
{
  ...
  if (r>=48 && r<=48) { return R3.Priority(); } 
  if (r>=49 && r<=49) { return R4.Priority(); } 
  if (r>=50 && r<=50) { return R5.Priority(); } 
  if (r>=51 && r<=51) { return R6.Priority(); } 
  if (r>=52 && r<=52) { return R7.Priority(); } 
  if (r>=53 && r<=53) { return R8.Priority(); } 
  if (r>=54 && r<=54) { return R9.Priority(); } 
  if (r>=55 && r<=55) { return R10.Priority(); } 
  if (r>=56 && r<=56) { return R11.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  ...
  if (r>=48 && r<=48) return R3.Name(r-48);
  if (r>=49 && r<=49) return R4.Name(r-49);
  if (r>=50 && r<=50) return R5.Name(r-50);
  if (r>=51 && r<=51) return R6.Name(r-51);
  if (r>=52 && r<=52) return R7.Name(r-52);
  if (r>=53 && r<=53) return R8.Name(r-53);
  if (r>=54 && r<=54) return R9.Name(r-54);
  if (r>=55 && r<=55) return R10.Name(r-55);
  if (r>=56 && r<=56) return R11.Name(r-56);
  return NULL;
}
};
...
{
for(int mu_i = 1; mu_i <= 1; mu_i++) {
mu_constructSpat7 ( mu_roleA[mu_i].mu_Na, mu_roleA[mu_i].mu_Nb, mu_roleA[mu_i].mu_B, mu_roleA[mu_i].mu_A, mu_gnum );
};
};
{
for(int mu_i = 1; mu_i <= 1; mu_i++) {
...
/********************
  Invariant records
 ********************/
int mu__invariant_200() // Invariant "auth1"
{
bool mu__quant201; 
mu__quant201 = TRUE;
{
...
bool mu__boolexpr202;
  if (!((mu_roleA[mu_i].mu_commit) == (mu_true))) mu__boolexpr202 = TRUE ;
  else {
bool mu__quant203; 
mu__quant203 = FALSE;
{
...
if ( ((mu_roleB[mu_i].mu_Na) == (mu_roleA[mu_j].mu_Na)) )
  { mu__quant203 = TRUE; break; }
};
};
  mu__boolexpr202 = (mu__quant203) ; 
}
if ( !(mu__boolexpr202) )
  { mu__quant201 = FALSE; break; }
};
};
return mu__quant201;
};

bool mu__condition_204() // Condition for Rule "auth1"
{
  return mu__invariant_200( );
}

/**** end rule declaration ****/

int mu__invariant_205() // Invariant "sec1"
{
bool mu__quant206; 
mu__quant206 = TRUE;
{
...
bool mu__boolexpr208;
  if (!((mu_msgs[mu_i].mu_msgType) == (mu_nonce))) mu__boolexpr208 = FALSE ;
  else {
  mu__boolexpr208 = ((mu_msgs[mu_i].mu_noncePart) == (mu_Nb)) ; 
}
  if (!(mu__boolexpr208)) mu__boolexpr207 = TRUE ;
  else {
  mu__boolexpr207 = ((mu_Spy_known[mu_i]) == (mu_false)) ; 
}
if ( !(mu__boolexpr207) )
...
bool mu__condition_209() // Condition for Rule "sec1"
{
  return mu__invariant_205( );
}

/**** end rule declaration ****/

const rulerec invariants[] = {
{"sec1", &mu__condition_209, NULL, },
{"auth1", &mu__condition_204, NULL, },
};
